# 1 "conditional-statments.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 406 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "conditional-statments.c" 2
...
# 2 "conditional-statments.c" 2
# 1 "./file.h" 1
int GLOBAL = 3;
# 3 "conditional-statments.c" 2
